...
public abstract class BaseInterfacesPresenter<V extends BaseInterfacesView, M extends BaseInterfacesModel> extends BasePresenter<V, M> {
    public BaseInterfacesPresenter(@NonNull V view, @NonNull M model) {
        super(view, model);
